...
- **Global scope**: `/Users/alimuratbekov/work/superset/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alimuratbekov/work/superset/.claude/notes/`)
...
2. Glob `/Users/alimuratbekov/work/superset/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alimuratbekov/work/superset/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alimuratbekov/work/superset/.claude/notes/` — works in any directory
