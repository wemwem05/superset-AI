...
- Usage: Reference from command with `@/Users/alimuratbekov/work/superset/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/alimuratbekov/work/superset/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/alimuratbekov/work/superset/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
